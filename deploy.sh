...
kubectl set image deployments/client-deployment client-deployment-container=saranraju90/multi-client:$SHA
kubectl set image deployments/worker-deployment worker-deployment-container=saranraju90/multi-worker:$SHA
kubectl set image deployments/server-deployment server-deployment-container=saranraju90/multi-server:$SHA