...
kubectl set image deployment/server-deployment server=saranraju90/multi-server:$SHA
kubectl set image deployment/client-deployment client=saranraju90/multi-client:$SHA
kubectl set image deployment/worker-deployment worker=saranraju90/multi-worker:$SHA